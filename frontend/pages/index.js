  ...
  return (
    <Layout>
      <div className='md:w-4/5 xl:w-3/5 mx-auto mb-32'>
        {url ? (
          <>
            <p className='text-center text-2xl'><span className='font-bold text-red-700 text-3xl uppercase mt-10'>Tu URL es:</span> {`${process.env.frontendURL}/enlaces/${url}`}</p>
            <button
              type="button"
              className='bg-red-500 hover:bg-red-900 w-full p-2 text-white font-bold uppercase mt-10'
