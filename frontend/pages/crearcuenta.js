...
const CrearCuenta = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            password: Yup.string().required("Password es obligatorio").min(6, "El password debe contener al menos 6 caracteres")
        }),
        onSubmit: valores => {
                ...
                >
                    <div className='mb-4'>
                        ...
                        {formik.touched.nombre && formik.errors.nombre ? (
                            <div className='my-2 bg-slate-200 border-l-4 border-red-500 text-red-700 p-4'>
                    ...
                    <input
                        type="submit"
                        className='bg-red-500 hover:bg-red-900 w-full p-2 text-white font-bold uppercase'
                        value="Crear cuenta"
                    />
                </form>
            </div>
